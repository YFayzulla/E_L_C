...
@section('subtitle', 'Talaba hisobini yaratish va guruhga biriktirish')
...
@section('content')
    ...
    <form action="{{ route('student.store') }}" method="POST" enctype="multipart/form-data" id="studentForm">
        @csrf
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="name" name="name"
                                       ...
                                       value="{{ old('name') }}" placeholder="Masalan: Aliyev Vali" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="tel" id="phone" name="phone" maxlength="9"
                                           ...
                                           value="{{ old('phone') }}" placeholder="901234567"
                                           inputmode="numeric" required>
                                </div>
                                @error('phone') <div class="text-danger mt-1" style="font-size: .8rem;">{{ $message }}</div> @enderror
                                <div class="form-text">Tizimga shu raqam orqali kiradi. Boshlang‘ich parol ham shu raqam.</div>
                            </div>

                            @include('partials.email-field', ['user' => null])
                                ...
                                <select id="group_id" name="group_id[]" class="choices form-select" multiple required
                                    ...
                                    @foreach($groups as $group)
                                        <option value="{{ $group->id }}" data-payment="{{ $group->monthly_payment }}"
                                                @if(is_array(old('group_id')) && in_array($group->id, old('group_id'))) selected @endif>
                                            {{ $group->name }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        @include('partials.guardian-fields', ['guardians' => []])
                    </div>
                </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="location" name="location"
                                       ...
                                       value="{{ old('location') }}" placeholder="Ixtiyoriy">
                            ...
                            <div class="col-12">
                                ...
                                <textarea id="description" name="description" rows="3"
                                          ...
                                          placeholder="Ixtiyoriy">{{ old('description') }}</textarea>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="form-text mt-2">
                            Har bir guruh uchun to‘lov guruhning standart narxidan olinadi, kerak bo‘lsa
                            o‘zgartiring.
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var oldGroupPayments = {!! json_encode(old('group_payment', [])) !!};
            ...
            function renderGroupPayments() {
                ...
                selected.forEach(function (opt) {
                    ...
                    input.value = (oldGroupPayments && oldGroupPayments[gid])
                        ? formatNumberWithSpaces(oldGroupPayments[gid])

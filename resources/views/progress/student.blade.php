...
@section('content')
    ...
    <div class="page-head">
        <div class="d-flex align-items-center gap-3">
            <a href="{{ $backUrl }}" class="btn-icon" title="Orqaga">
        ...
        <a href="{{ route('student.show', $student->id) }}" class="btn btn-outline-secondary">
            <i class="bx bx-user me-1"></i> Kartochka
        </a>
    </div>
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="text-muted mt-3 mb-0" style="font-size: .78rem;">
                        ...
                        Ma’lumot bo‘lmagan tarkibiy qism hisobga olinmaydi — ulushlar qolganlari o‘rtasida qayta taqsimlanadi.
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-6">
            <div class="card h-100">
                <div class="card-header">So‘nggi test natijalari</div>
                @if($evidence['tests']->isEmpty())
                    <div class="empty-state py-4">
                        <i class="bx bx-clipboard"></i>
                        <h6>Natija yo‘q</h6>
                        <p class="mb-0">Test natijalari kiritilmagan.</p>
                    </div>
                @else
        ...
        <div class="col-lg-6">
            <div class="card h-100">
                <div class="card-header">So‘nggi uy vazifalari</div>
        ...
        <div class="col-lg-6">
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    @if($reportGroupId)
                        <a href="{{ route('skills.report', $reportGroupId) }}"
                           class="btn btn-sm btn-outline-secondary">Hisobot</a>
                    @endif
                </div>
                @if($evidence['skills']->isEmpty())
                    <div class="empty-state py-4">
                        ...
                        <h6>Baho yo‘q</h6>
                        <p class="mb-0">Ko‘nikma bahosi qo‘yilmagan.</p>
                    </div>
                @else
                    <div class="table-responsive">
                        <table class="table table-hover">
        ...
        <div class="col-lg-6">
            <div class="card h-100">
                <div class="card-header">So‘nggi qoldirilgan darslar</div>
                @if($evidence['absences']->isEmpty())
                    <div class="empty-state py-4">
                        <i class="bx bx-check-circle"></i>
                        <h6>Qoldirilgan dars yo‘q</h6>
                        <p class="mb-0">Barcha darslarda qatnashgan.</p>
                    </div>
                @else
                    <div class="table-responsive">
                        <table class="table table-hover">
